...
class ScaleReader:
    ...
    This operation has 2 prerequisites:
        ...
        2. Calibration data specifying pixel values of the four corners of
            ...
            obtained using the calibration script inside the project folder
    The code assumes:
    ...
    def read_weight(self, image: Image) -> float:
        """
    ...
    def prepare_lcd_region_of_interest(self):
        ...
        lcd_region = self.image.transform(self.image.size, Image.QUAD, [
        ...
        (width, height) = lcd_region.size
        small_size = (width // self.resize_factor,
                      height // self.resize_factor)
        lcd_region.resize(small_size)

        self.region_of_interest = lcd_region
    ...
    def isolate_red_pixels(self):
        ...
        a value of 0 means 'below that ratio'
        """
        ...
        for x in range(self.region_of_interest.size[0]):
            for y in range(self.region_of_interest.size[1]):
                ...
                red_proportion = max(0, (red - (green + blue)))

                if red_proportion > 10:
